			...
			if player and player.Character then
				...
				if face:IsA("Decal") then-- if it's a validz face, then...
					if tool == face.Texture then
						local targetplayer = face.Parent.Parent

						--Folders
						local xraypart = targetplayer.HumanoidRootPart
						local xraylabel = targetplayer.Head
						...
						local function createSGUI(face)			
							...
							frame.BackgroundColor3 = Color3.new(200,0,0)
